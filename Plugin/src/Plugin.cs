...
namespace BaldiEnemy {
    ...
    public class Plugin : BaseUnityPlugin {
        ...
        private void Awake() {
            ...
            var BaldiEnemy = ModAssets.LoadAsset<EnemyType>("Baldi");
            var BaldiEnemyTN = ModAssets.LoadAsset<TerminalNode>("BaldiEnemyTN");
            var BaldiEnemyTK = ModAssets.LoadAsset<TerminalKeyword>("BaldiEnemyTK");

            // Optionally, we can list which levels we want to add our enemy to, while also specifying the spawn weight for each.
            /*
            var BaldiEnemyLevelRarities = new Dictionary<Levels.LevelTypes, int> {
            ...
            var BaldiEnemyCustomLevelRarities = new Dictionary<string, int> {
                {"EGyptLevel", 50},
            ...
            */
            ...
            NetworkPrefabs.RegisterNetworkPrefab(BaldiEnemy.enemyPrefab);
